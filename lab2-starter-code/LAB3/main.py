...
tone1 = Sound(duration=0.5, volume=100, pitch="C4")
tone2 = Sound(duration=0.5, volume=100, pitch="D4")
tone3 = Sound(duration=0.5, volume=100, pitch="E4")
tone4 = Sound(duration=0.5, volume=100, pitch="G4")
